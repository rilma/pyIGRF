...
C*********************************************************************
        ...
        subroutine igrf_sub(xlat,xlong,year,height,dirdata,
     &          xl,icode,dip,dec)
c----------------------------------------------------------------
c   INPUT:
...
Cf2py intent(in) xlat,xlong,year,height,dirdata
Cf2py intent(out) xl,icode,dip,dec
...
c 667    FORMAT('/var/www/omniweb/cgi/vitmo/IRI/',A13)
        filename = trim(trim(dirdata1) // trim(FOUT))
